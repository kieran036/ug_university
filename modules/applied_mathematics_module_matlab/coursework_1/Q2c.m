function[ ExpSeq ] = Q2c( k , x0 , delta , nmax )
%Exponential sequence x_(n+1) = k*exp((x_n)), which is being used as an
%approximation method to find a solution by iteration
